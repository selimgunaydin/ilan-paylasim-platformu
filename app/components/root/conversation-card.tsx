            ...
            <Avatar className="h-12 w-12">
              <AvatarImage
                src={getProfileImageUrl(
                  conversation[type === 'sent' ? 'receiver' : 'sender']?.profileImage,
                  conversation[type === 'sent' ? 'receiver' : 'sender']?.gender || "unspecified",
                  conversation[type === 'sent' ? 'receiver' : 'sender']?.avatar
                )}
                alt={conversation[type === 'sent' ? 'receiver' : 'sender']?.username}
              />
              <AvatarFallback>
                {conversation[type === 'sent' ? 'receiver' : 'sender']?.username?.[0]?.toUpperCase()}
              </AvatarFallback>
            </Avatar>
            <div className="flex-1 min-w-0">
              <p className="font-medium truncate">
                {conversation[type === 'sent' ? 'receiver' : 'sender']?.username}
              </p>
