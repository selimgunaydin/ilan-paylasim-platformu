    ...
    return (
      <div className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen py-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center mb-6 text-sm bg-white px-4 py-3 rounded-lg shadow-sm">
            ...
            {parentCategory && (
              <>
                <Link href={`/kategori/${parentCategory.slug}`} className="text-gray-500 hover:text-blue-600">
                  {parentCategory.name}
                </Link>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mx-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            {category && (
              <>
                <Link href={`/kategori/${category.slug}`} className="text-gray-500 hover:text-blue-600">
                  {category.name}
                </Link>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mx-2 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                <div className="p-6">
                  <div className="flex items-center justify-between flex-wrap gap-3">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900 flex-grow">{listing.title}</h1>
                  ...
                  <div className="mt-4 flex flex-wrap items-center text-sm text-gray-500 gap-x-6 gap-y-2">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden p-6">
                ...
                <div className="prose max-w-none">
                  {listing.description ? (
                    ...
                    <p className="text-gray-500 italic">Bu ilan için detay bilgisi bulunmuyor.</p>
                  )}
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden p-6">
                    ...
                    .map((similarListing:any) => (
                      ...
                      >
                        <div className="bg-gray-50 border border-gray-200 rounded-lg overflow-hidden transition-all duration-200 hover:shadow-md group-hover:border-blue-300">
                          <div className="p-4">
                            <h3 className="font-medium text-gray-900 group-hover:text-blue-600 transition-colors mb-2 line-clamp-1">
                ...
                {similarListingsResponse.listings?.filter((l:any) => l.id !== listing.id).length === 0 && (
                  <p className="text-gray-500 text-center py-4">Bu kategoride başka ilan bulunmuyor.</p>
                )}
                
                {similarListingsResponse.listings?.filter((l:any) => l.id !== listing.id).length > 4 && (
            ...
            <div className="lg:col-span-4 space-y-6">
                  ...
                  {listing.contactPerson && (
                    <div className="py-3 flex items-start">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">{listing.contactPerson}</p>
                      </div>
                    </div>
                  )}
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-md overflow-hidden border border-blue-100">
                <div className="p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">İlan Sahibi ile İletişime Geç</h3>
                  <p className="text-sm text-gray-600 mb-4">
                    Bu ilan ile ilgili daha fazla bilgi için ilan sahibine ulaşın.
                  </p>
                  ...
                  {listing.phone ? (
                    ...
                    <button
                      disabled
                      className="w-full bg-gray-400 text-white font-medium py-2 px-4 rounded flex items-center justify-center cursor-not-allowed"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl shadow-md overflow-hidden">
                <div className="p-6 text-white">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-semibold">Öne Çıkan</h3>
                    <span className="text-xs bg-white/20 px-2 py-1 rounded">Reklam</span>
                  </div>
                  <p className="text-sm opacity-90 mb-4">
                    Siz de ilanınızı öne çıkarmak ister misiniz? Premium üyelik ile ilanlarınız daha fazla kişiye ulaşsın!
                  </p>
                  <a 
                    href="/premium-uyelik" 
                    className="block w-full bg-white text-purple-700 text-center font-medium py-2 px-4 rounded-lg hover:bg-purple-50 transition-colors"
                  >
                    Daha Fazla Bilgi
                  </a>
                </div>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">İlan Yüklenemedi</h2>
          <p className="text-gray-600 mb-6">İlan bilgileri yüklenirken bir hata oluştu. Lütfen daha sonra tekrar deneyin.</p>
